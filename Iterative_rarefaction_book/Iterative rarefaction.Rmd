...
In our initial R community analysis workshop we only carried out one round of __rarefaction__ for each sample.
...
Carry this to determien the randomness of sampling.
