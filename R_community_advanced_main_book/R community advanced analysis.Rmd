...
We provide the function with our __beta diversity dissimilarity matrix__.
Additionally, we provide it with the parameter `k = 2`.
This is the number of dimensions we want, we want 2 as we will only be plotting an x and y axis i.e. 2 dimensions.
