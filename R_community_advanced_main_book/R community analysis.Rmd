...
Sample the object `second_millenium` with the following values:
...
- Extract 24 values
- Without replacement
- Use the answer to the previous question as the random seed
...
- With replacement
- Use the first question as the random seed
