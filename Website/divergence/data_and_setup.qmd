# Data & Setup
<center>
![](/images/setup_5.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
In the jupyter-notebook file explorer create and move into a new directory called `divergence`, ensure this is a subdirectory of the main workshop directory (`adv_R_comm`).
