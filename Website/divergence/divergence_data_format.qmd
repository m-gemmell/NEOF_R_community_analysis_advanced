...
Our initial dissimilarity distance data is in a square distance matrix will be like below:
...
When the above example distance matrix is converted into [long data frame/tibble](https://neof-workshops.github.io/Tidyverse/ggplot2/input_data.html) for divergence analysis it will then look like:
