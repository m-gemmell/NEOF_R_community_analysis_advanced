...
In other word we want to examine the media inter-/intra-distances of the intra-site distances.
...
- We can see that he inter-distances for the ENV LD samples are much lower than for the other ENV MD and ENV UD samples.

Although these are intra-replicate distances this might not be the case for your own data. 
If you have groupings based on more than 2 primary groupings, such as site, media, and date, you should not discuss these types of findings in terms of replicates.
