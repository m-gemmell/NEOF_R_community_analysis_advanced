...
This can be especially useful when comparing three or more sample groups as is let's us mor confidently determine which sample groups are more similar to each other.
...
All the inter-group pairwise distances for the G3 sample:
