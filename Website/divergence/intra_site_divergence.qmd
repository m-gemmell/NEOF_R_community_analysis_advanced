...
- Carry out a pairwise wilcox test to statistically compare the divergences between sites.
...
Our first step is to subset out [tibble](https://neof-workshops.github.io/Tidyverse/tibble/tibble.html) so we only have the intra-site distances.

For this step we pip ([`|>`](https://neof-workshops.github.io/Tidyverse/dplyr/pipes.html)) our weighted UniFrac long [tibble](https://neof-workshops.github.io/Tidyverse/tibble/tibble.html) to 2 different ['dplyr::filter()'](https://neof-workshops.github.io/Tidyverse/dplyr/filter.html) commands.
...
A bxo plot is a good method to visualise divergence.
