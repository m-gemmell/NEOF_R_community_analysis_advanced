...
With this you can see that we have 36 non-significant `Reads` associations in `sig_res_reads_abund_tbl`.
...
sig_res_reads_abund_tbl |> 
    #Extract the twenty rows with the smallest qval_individual values
