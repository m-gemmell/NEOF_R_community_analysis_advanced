...
These heatmaps are further split by metadata/effects, in this case `Reads` and `TimepointNamePool_visits7,8,9`.
...
- __Stars:__ The significance threshold
    ...
    - Note: We have no 2 star associations in our heatmap
