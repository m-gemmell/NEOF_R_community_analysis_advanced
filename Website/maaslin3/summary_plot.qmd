...
coef_plot_variables <- c("", "Sample Scalp")
#Set order of heatmap variables for plot recreation
#Do not include V1 since it is the reference
heatmap_variables <-
    c("Visit V2","Visit V3","Visit V4","Visit V5","Visit V6",
     "Visit V7","Visit V8","Visit V9","Visit V10","Visit V11","Visit V12")
```
...
- Coefficient heatmap
    - On the right side
    - One plot is for the prevalence logistic modelling of all the fixed effect comparisons not in the coefficient plot (unless you choose them with replotting)
    - One plot is for the abundance linear modelling of all the fixed effect comparisons not in the coefficient plot (unless you choose them with replotting)
