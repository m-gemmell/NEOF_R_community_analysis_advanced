...
We use ASV counts rather than taxa counts such as phyla.
Though you can use taxa counts for alpha and beta diversity using ASVs is normally the first approach.

These materials are mostly a combination of the __iterative rarefaction__ in this book and the __alpha diversity__ analysis in the [R community workshop](https://neof-workshops.github.io/R_community_whqkt8/Course/15-Alpha.html).
...
- __Rarefaction size:__ The sequence depth to normalise samples to
  ...
  - More info in the [R community workshop](https://neof-workshops.github.io/R_community_whqkt8/Course/14-Rarefaction.html)
- __RNG seeds:__ The rng seeds we will use for all the rarefactions
  - We created these in the previous [section](/rarefaction/iterating_rarefaction.qmd#rng_vec_creation)
