# β considerations
![](images/consider.png){style="width:200px; border-radius:5px; background:white; border: white solid 5px" fig-align="center"}

There are many considerations to take in mind when carrying out beta diversity analysis.

## Which distance measures to use?
![](images/inch_or_mm.xcf.png){style="width:150px; border-radius:5px; background:white; border: white solid 5px" fig-align="center"}
...
![](images/compass_2.png){style="width:150px; border-radius:5px; background:white; border: white solid 5px" fig-align="center"}
...
There is one paper that recommends you create, publish, and stick to a statistical plan before carrying out your analysis. 
...
## More dimensions
![](images/3d.png){style="width:150px; border-radius:5px; background:white; border: white solid 5px" fig-align="center"}
