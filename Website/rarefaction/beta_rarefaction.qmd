...
Now that we know how to create a __beta diversity__ paired distance matrix, we can create one with averaged values produced by __iterative rarefaction__.
