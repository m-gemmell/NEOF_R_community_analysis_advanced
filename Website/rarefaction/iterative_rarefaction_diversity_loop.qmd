...
::: {.callout-note}
This page does not contain any code for producing plots or stats.
:::


This page is primarily provided as a template which you can copy, paste, and edit for you own analyses.
Ensure you check through all the code as well as making relevant edits when you do so.
...
```{R, eval=FALSE}
#Iteration based rarefied diversity values
...
#Bray-curtis
bray_df_sum <- rbiom::bdiv_matrix(
    biom = biom_rarefy,
    bdiv="bray")
#Jaccard
jaccard_df_sum <- rbiom::bdiv_matrix(
    biom = biom_rarefy,
    bdiv="jaccard")
