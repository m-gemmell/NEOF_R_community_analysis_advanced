...
1. Subsetting the data so it only contains the 9 environmental samples.
2. Aggregating the taxa to phyla whilst [aggregating rare taxa](https://neof-workshops.github.io/R_community_whqkt8/Course/11-Taxa_plots.html#aggregateraretaxa) to one "other" group
