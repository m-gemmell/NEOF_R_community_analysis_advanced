# All in one code
<center>
![](images/all_in.png){style="width:200px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
#### MCQs
<center>
![](/images/question_bubble_purple.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
