# Data & Setup
<center>
![](images/setup_8.png){style="width:200px; ; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
In the jupyter-notebook file explorer create and move into a new directory called `upset`, ensure this is a subdiretcory of the main workshop directory (`adv_R_comm`).
...
## Libraries
<center>
![](images/packages.png){style="width:200px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
<center>
![](images/river.png){style="width:200px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
