...
- Ensure you have setup your directory, environment, and jupyter-notebook as shown in the overall [setup](/setup/setup.qmd)
...
In jupyter-notebook file explorer create and move into a new directory called "upset", ensure this is a subdiretcory of the main workshop directory (`adv_R_comm`).
