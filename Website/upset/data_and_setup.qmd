...
In the jupyter-notebook file explorer create and move into a new directory called `upset`, ensure this is a subdirectory of the main workshop directory (`adv_R_comm`).
