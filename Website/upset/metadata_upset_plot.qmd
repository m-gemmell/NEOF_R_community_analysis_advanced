...
OUr lasts steps our to format the data into an upset __tibble__ and then create the upset plot.
...
Carrying it out this way ensures that if a genus is present in at least one of the samples of a metadata group, it will be included in interaction.
