...
## Number of taxa
<center>
![](images/tally.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
<center>
![](images/origami_rhino.png){style="width:200px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
## Upset plot creation
<center>
![](images/pencil.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
