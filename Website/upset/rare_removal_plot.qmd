...
The easiest method to determine the number of taxa groups at certain taxonomic level is by aggregating the phyloseq object and display the dimension data of the objects within the aggregated phyloseq object.
