...
## Rare aggregation
<center>
![](images/elephant_origami.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
<center>
![](images/paint_brush.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
