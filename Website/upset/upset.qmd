...
![](images/upset_plot_icon.png){style="width:300px; background: white; border-radius:15px; border:5px white solid" fig-align="center"}
...
- S1 & S4 share three phyla not present in S2 or S3.
