# Upset data format
<center>
![](images/format.png){style="width:200px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
## Upset tibble
<center>
![](images/2_column_table.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
...
## MCQs
<center>
![](/images/question_bubble_green.png){style="width:150px; background: white; border: white solid 5px; border-radius: 5px"}
</center>
